        ...
        <Card className="fixed bottom-20 right-4 w-80 h-96 shadow-xl z-50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-black-50 dark:bg-black-950">
            <CardTitle className="text-sm font-medium flex items-center gap-2">
              <Scale className="h-4 w-4 text-black-600" />
              ...
              <div className="space-y-4">
                {messages.length === 0 && (
                  <div className="text-sm text-muted-foreground">
                    ⚖️ Olá! Sou o assistente do Despachante DevTools. Como posso ajudá-lo com seus serviços jurídicos hoje?
                  </div>
                )}
                ...
                {isLoading && (
                  <div className="flex justify-start">
                    <div className="bg-muted rounded-lg px-3 py-2 text-sm flex items-center gap-2">
                      <Scale className="h-3 w-3 animate-pulse text-black-500" />
                      Pensando...
                    </div>
                  </div>
                )}
