    ...
    try {
      ...
      if (!user) {
        toast({
          ...
          description: "Faça login para contratar nossos serviços jurídicos.",
          action: (
      ...
      toast({
        ...
        description: `${product.title} foi adicionado aos serviços contratados.`,
        duration: 2000,
      })
    } catch (error) {
      ...
      toast({
        title: "Erro",
        description: "Não foi possível adicionar o serviço aos contratados.",
        variant: "destructive"
      })
    }
  }
