...
// áreas/serviços jurídicos — mapeie nomes que seu Firestore irá retornar
"trabalhista": Flame,
"civil": Mountain,
"criminal": Activity,
"contratos": Shirt,
"empresarial": Crown,
"tributario": BadgeDollarSign,
"sucessorio": Stars,
"familia": ShoppingBag,
"processual": Activity,
"lgpd": Sparkles,
"propriedade-intelectual": Crown,
"direitos": BadgeDollarSign,
"administrativo": Mountain,
"comercial": Flame,
"tecnologia": Shirt,
"ambiental": Mountain,
"publico": Crown,
"societario": Shirt,
"representacao": Activity,
"documentos": Sparkles,
"parecer": Stars,
"provas": BadgeDollarSign,
"gravames": Flame,
"corporate": Crown
}
...
Consultoria, contencioso, contratos, compliance e soluções jurídicas para empresas e pessoas.
</p>
</div>
  ...
  <div className="flex flex-wrap justify-center gap-2">
    ...
    {categories.map((categoryName) => {
      ...
      const Icon = categoryIconMap[key] || Sparkles
  ...
  <div className="flex flex-wrap justify-center gap-4 text-sm font-elegant">
    <div className="flex items-center gap-2">
      <span className="text-muted-foreground">Tipo / Escopo:</span>
      {sizes.map((size) => (
        <button
          key={size}
