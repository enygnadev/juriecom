...
async function setupAdmin() {
  try {
    ...
    const adminUser = {
      email: 'admin@juriecommerce.com',
      name: 'Administrador',
      displayName: 'Administrador Juridico Ecommerce',
      isAdmin: true,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    console.log('📧 Email: admin@juriecommerce.com');
    ...
    console.log('2. Usar email: admin@juriecommerce.com');
